    ...
    return ChainList.deployed()
      ...
      .then(function(receipt) {
        ...
        assert.equal(
          ...
          "SellArticleEvent",
          "event name should be SellArticleEvent"
        );
        ...
        assert.equal(
          ...
          web3.toWei(articlePrice1, "ether"),
          "article price must be " + web3.toWei(articlePrice1, "ether")
        );
    ...
    return ChainList.deployed()
      ...
      .then(function(receipt) {
        ...
        assert.equal(
          receipt.logs[0].args._price.toNumber(),
          web3.toWei(articlePrice2, "ether"),
          "event article price must be " + web3.toWei(articlePrice2, "ether")
        );
      ...
      .then(function(data) {
        ...
        assert.equal(
          data[5].toNumber(),
          web3.toWei(articlePrice2, "ether"),
          "article price must be " + web3.toWei(articlePrice2, "ether")
        );
      });
  });
    ...
    return ChainList.deployed()
      ...
      .then(function(receipt) {
        ...
        assert.equal(
          receipt.logs[0].event,
          "BuyArticleEvent",
          "event should be BuyArticleEvent"
        );
        assert.equal(
